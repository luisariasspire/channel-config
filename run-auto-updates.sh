...
do
    poetry run python -m channel_tool auto-update production all_gs $(basename "$file" .csv) --parameter=link_profile --data-column=actual_downlink_kbps --source-file="$file" -y
